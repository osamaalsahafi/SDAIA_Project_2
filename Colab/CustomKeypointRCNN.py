...
class CustomKeypointRCNN:
    ...
    def train(
        ...
        for epoch in range(num_epochs):
            ...
            for batch in train_loader:
                ...
                #             key,
                #             type(value),
                #             value.shape if isinstance(value, torch.Tensor) else None,
                #         )
            ...
            self.model.train()
            self._log(f"Epoch {epoch + 1}: Validation loss = {val_loss}", "verbose")
    ...
    def predict(self, image):
        ...
        # Assuming the input image is a numpy array of shape (H, W, C)
